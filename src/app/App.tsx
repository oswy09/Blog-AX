...
import { Routes, Route, Navigate, useNavigate } from './router';
import Slider from 'react-slick';
import 'slick-carousel/slick/slick.css';
import 'slick-carousel/slick/slick-theme.css';
import { Search, ChevronLeft, ChevronRight, Calendar, Clock, Eye, ArrowRight, ChevronRight as ChevRight, ChevronDown, X, User } from 'lucide-react';
...
function CategoryBadge({ category }: { category: string }) {
  ...
  return (
    <span
      ...
      style={{ backgroundColor: color, fontFamily: "'Source Sans Pro', sans-serif" }}
    >
      {category}
    </span>
  );
...
function PlayButton({ size = 'md' }: { size?: 'sm' | 'md' | 'lg' }) {
  ...
  const arrowSize = size === 'sm' ? 'border-t-[5px] border-l-[9px] border-b-[5px]' : size === 'lg' ? 'border-t-[10px] border-l-[18px] border-b-[10px]' : 'border-t-[7px] border-l-[13px] border-b-[7px]';
  return (
    <div className={`${dims} rounded-full bg-white/95 flex items-center justify-center shadow-lg`}>
      <div className={`w-0 h-0 ${arrowSize} border-t-transparent border-b-transparent border-l-[#D24723] ml-1`} />
    </div>
  );
}
...
function FilterDropdown({ placeholder, options, value, onChange }: {
  ...
  return (
    <div className="relative">
      <button
        onClick={() => setOpen(o => !o)}
        className="flex items-center justify-between gap-3 border border-gray-300 rounded-xl px-4 py-2.5 bg-white text-sm transition-colors min-w-[190px] hover:border-[#00008F] focus:border-[#00008F] focus:outline-none"
          ...
          {options.map(opt => (
            <button
              ...
              className={`w-full text-left px-4 py-2.5 text-sm transition-colors ${
                value === opt ? 'bg-[#00008F]/5 text-[#00008F] font-semibold' : 'text-gray-700 hover:bg-gray-50'
              }`}
              style={{ fontFamily: "'Source Sans Pro', sans-serif" }}
            >
              {opt}
...
function HomePage() {
  ...
  const filteredRecent = recentPosts.filter(p =>
    ...
    (activeTags.length === 0 || activeTags.includes(p.category))
  );
  ...
  return (
    <div className="min-h-screen bg-gray-50" style={{ fontFamily: "'Source Sans Pro', sans-serif" }}>
      ...
      <div className="bg-gray-50 border-b border-gray-200">
        <div className="max-w-[1280px] mx-auto px-4 flex items-center h-8">
          ...
          <div className="flex items-center gap-5 ml-auto">
            ...
            <button
              className="border border-[#00008F] text-[#00008F] hover:bg-[#00008F] hover:text-white text-xs font-semibold px-4 h-8 transition-colors"
              style={{ fontFamily: "'Source Sans Pro', sans-serif" }}
            >
              Paga aquí
            </button>
        ...
        <div className="max-w-[1280px] mx-auto px-4">
          <div className="flex items-center h-[52px] gap-8">
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              <button
                className="bg-[#00008F] hover:bg-[#0000b3] text-white text-sm font-semibold px-4 py-2 transition-colors whitespace-nowrap"
                style={{ fontFamily: "'Source Sans Pro', sans-serif" }}
              >
                Cotiza tu seguro aquí
              </button>
              <button
                className="border border-[#00008F] text-[#00008F] hover:bg-[#00008F] hover:text-white text-sm font-semibold px-4 py-2 transition-colors whitespace-nowrap"
                style={{ fontFamily: "'Source Sans Pro', sans-serif" }}
              >
                Contáctanos
              </button>
      ...
      <section
        ...
        style={{
          backgroundImage: `url(https://www.axacolpatria.co/documents/42201273/156411758/banner-vida-en-casa.webp/2960ab3f-161f-a106-6dc8-472e446c57d0?t=1755812539060)`,
      ...
      >
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center max-w-4xl mx-auto px-8">
          <p className="text-white text-2xl font-normal mb-3 tracking-wide" style={{ fontFamily: "'Source Sans Pro', sans-serif" }}>
            Blog
          </p>
          <h1
            className="text-white leading-tight"
            style={{ fontFamily: "'Publico Headline Web', serif", fontWeight: 700, fontSize: 'clamp(1.75rem, 3.5vw, 2.6rem)' }}
          >
      ...
      <div className="bg-white border-b border-gray-100 shadow-sm">
        <div className="max-w-4xl mx-auto px-6 py-10">
          ...
          <div className="flex flex-col sm:flex-row gap-2 mb-5">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-xl text-sm text-gray-700 placeholder-gray-400 focus:outline-none focus:border-[#00008F] transition-colors"
                style={{ fontFamily: "'Source Sans Pro', sans-serif" }}
              />
            </div>
            ...
            {hasActiveFilters && (
              <button
                ...
                className="flex items-center gap-1 px-3 py-2.5 text-xs font-medium text-[#D24723] border border-[#D24723]/30 rounded hover:bg-[#D24723]/5 transition-colors whitespace-nowrap"
                style={{ fontFamily: "'Source Sans Pro', sans-serif" }}
              >
                <X size={13} /> Limpiar
              </button>
          ...
          <div className="flex gap-2 flex-wrap justify-center">
            <button
              onClick={() => { setActiveTags([]); setSelectedCategory('Todos'); }}
              className={`px-5 py-1.5 rounded-full text-sm font-semibold transition-all border ${
                activeTags.length === 0 && selectedCategory === 'Todos'
                  ? 'bg-[#00008F] text-white border-[#00008F]'
                  : 'bg-white text-[#00008F] border-[#00008F]/30 hover:bg-[#00008F]/5'
              }`}
              style={{ fontFamily: "'Source Sans Pro', sans-serif" }}
            >
              Todos
            ...
            {categories.filter(c => c !== 'Todos').map(tag => (
              <button
                ...
                className={`px-5 py-1.5 rounded-full text-sm font-semibold transition-all border ${
                  activeTags.includes(tag) || selectedCategory === tag
                    ? 'bg-[#00008F] text-white border-[#00008F]'
                    : 'bg-white text-[#4976BA] border-[#4976BA]/40 hover:border-[#00008F] hover:text-[#00008F]'
                }`}
                style={{ fontFamily: "'Source Sans Pro', sans-serif" }}
              >
                {tag}
      ...
      <section className="bg-white py-10">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-2xl mb-5" style={{ fontFamily: "'Publico Headline Web', serif", fontWeight: 700, color: '#00008F' }}>
            Destacados de la semana
          </h2>
          <div className="relative w-full h-[340px] rounded-xl overflow-hidden cursor-pointer group" onClick={() => navigate(`/articulo/${featuredPosts[0].id}`)}>
            ...
            <div className="absolute bottom-0 left-0 p-8 max-w-2xl">
              <h3 className="text-white text-2xl md:text-3xl leading-snug mb-3" style={{ fontFamily: "'Publico Headline Web', serif", fontWeight: 700 }}>
                {featuredPosts[0].title}
              </h3>
              <p className="text-white/80 text-sm leading-relaxed line-clamp-2 mb-4" style={{ fontFamily: "'Source Sans Pro', sans-serif" }}>
              ...
              <div className="flex items-center gap-3">
                ...
                <p className="text-white/60 text-xs" style={{ fontFamily: "'Source Sans Pro', sans-serif" }}>
      ...
      {/* ── Recomendados para ti + Sidebar ── */}
      <section className="py-10 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            <div className="lg:col-span-2">
              <h2 className="text-2xl mb-6" style={{ fontFamily: "'Publico Headline Web', serif", fontWeight: 700, color: '#00008F' }}>
                Recomendados para ti
              </h2>
              <div className="grid grid-cols-2 gap-6">
                {(filteredRecent.length > 0 ? filteredRecent : recentPosts)
                  .concat(filteredBlog.length > 0 ? filteredBlog : blogPosts)
                  .slice(0, 6)
                  .map(post => (
            ...
            <div className="lg:col-span-1 space-y-8">
              <div>
                <h2 className="text-xl mb-4" style={{ fontFamily: "'Publico Headline Web', serif", fontWeight: 700, color: '#00008F' }}>
                  Recientes
                </h2>
                  ...
                  {mostReadPosts.slice(0, 3).map(post => (
                    <div key={post.id} className="flex items-start gap-3 py-3 cursor-pointer group" onClick={() => navigate(`/articulo/${post.id}`)}>
                      ...
                      <div className="flex-1 min-w-0">
                        <h4 className="text-[14px] font-bold leading-snug text-gray-900 line-clamp-2 group-hover:text-[#00008F] transition-colors mb-1" style={{ fontFamily: "'Publico Headline Web', serif" }}>
                          {post.title}
                        </h4>
                        <p className="text-xs text-gray-400 line-clamp-1 mb-1" style={{ fontFamily: "'Source Sans Pro', sans-serif" }}>
                          {post.excerpt}
                        </p>
                        <p className="text-xs text-gray-400 flex items-center gap-1" style={{ fontFamily: "'Source Sans Pro', sans-serif" }}>
              ...
              <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
                <h3 className="text-base font-bold text-gray-800 mb-4 flex items-center gap-2" style={{ fontFamily: "'Publico Headline Web', serif" }}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#7698CB" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div className="flex flex-wrap gap-2">
                  {['#Bienestar','#ARL','#Finanzas','#Prevención','#Salud','#Seguros','#Sostenibilidad','#SOAT','#Riesgos Laborales','#Estilo de Vida','#Movilidad','#Pyme','#Hogar'].map(tag => {
                    const tagName = tag.replace('#', '');
                    const categoryMap: Record<string, string> = {
                      'Bienestar': 'Bienestar', 'ARL': 'ARL', 'Finanzas': 'Seguros',
                      'Prevención': 'Prevención', 'Salud': 'Salud', 'Seguros': 'Seguros',
                      'SOAT': 'Seguros', 'Movilidad': 'Movilidad', 'Pyme': 'Seguros',
                      'Hogar': 'Prevención', 'Sostenibilidad': 'Bienestar',
                      'Estilo de Vida': 'Bienestar', 'Riesgos Laborales': 'ARL',
                    };
                    const category = categoryMap[tagName] || tagName;
                    return (
                      <span
                        key={tag}
                        className="text-xs text-gray-600 border border-gray-200 rounded-full px-3 py-1 hover:border-[#00008F] hover:text-[#00008F] hover:font-bold cursor-pointer transition-colors"
                        style={{ fontFamily: "'Source Sans Pro', sans-serif" }}
      ...
      {/* ── Conoce en menos de 2 minutos ── */}
      <section style={{ backgroundColor: '#070E40' }} className="py-14">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-white text-center mb-10" style={{ fontFamily: "'Publico Headline Web', serif", fontWeight: 700, fontSize: 'clamp(2rem, 3.5vw, 2.8rem)' }}>
            Conoce en menos de 2 minutos...
          </h2>
      ...
      <section className="py-14 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-2xl" style={{ fontFamily: "'Publico Headline Web', serif", fontWeight: 700, color: '#00008F' }}>
              Sigue explorando
            </h2>
            <a href="#" className="text-sm font-semibold text-[#00008F] hover:text-[#4976BA] flex items-center gap-1 transition-colors" style={{ fontFamily: "'Source Sans Pro', sans-serif" }}>
              Ver todos <ChevRight size={16} />
            </a>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {exploreMore.map(post => (
              <article key={post.id} className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all cursor-pointer group" onClick={() => navigate(`/articulo/${post.id}`)}>
                ...
                <div className="p-6">
                  <p className="text-xs text-gray-400 mb-2 flex items-center gap-1" style={{ fontFamily: "'Source Sans Pro', sans-serif" }}>
                    <Calendar size={12} /> {post.date}
                  </p>
                  <h3 className="text-lg font-bold text-gray-800 mb-2 group-hover:text-[#00008F] transition-colors leading-snug" style={{ fontFamily: "'Publico Headline Web', serif" }}>
                    {post.title}
                  </h3>
                  <p className="text-sm text-gray-500 line-clamp-2 mb-4" style={{ fontFamily: "'Source Sans Pro', sans-serif" }}>
                    {post.excerpt}
                  </p>
                  <span className="inline-flex items-center gap-1 text-[#00008F] text-sm font-semibold group-hover:gap-2 transition-all" style={{ fontFamily: "'Source Sans Pro', sans-serif" }}>
